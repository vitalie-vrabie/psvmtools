...
FunctionsToExport = @('Invoke-VMBackup', 'Repair-VhdAcl', 'Restore-VMBackup', 'Restore-OrphanedVMs', 'Remove-GpuPartitions')
...
AliasesToExport = @('hvbak', 'hv-bak', 'fix-vhd-acl', 'hvrestore', 'hvrecover', 'nogpup')
