...
FunctionsToExport = @('Invoke-VMBackup', 'Repair-VhdAcl', 'Restore-VMBackup', 'Restore-OrphanedVMs')
...
AliasesToExport = @('hvbak', 'hv-bak', 'fix-vhd-acl', 'hvrestore', 'hvrecover')
